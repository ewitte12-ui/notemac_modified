...
import { defineMonacoThemes, defineCustomMonacoTheme } from "../../Configs/ThemeConfig";
...
export function useEditorSetup(
  ...
  return useCallback<OnMount>(
    (editor, monaco) => {
      ...
      // For custom themes, define 'notemac-custom' with the user's editorBg before applying it
      if ('notemac-custom' === theme.editorMonacoTheme && theme.customMonacoBase)
          defineCustomMonacoTheme(monaco, theme.customMonacoBase, theme.editorBg);
    ...
    [tab.id, tab.scrollTop, theme.editorMonacoTheme, theme.editorBg, theme.customMonacoBase, updateTab, setMonacoReady]
  );
}
